...
Revision ID: 4f5c46dd38f6
Revises: c82976818c10
Create Date: 2021-03-19 02:42:34.603425
...
revision = '4f5c46dd38f6'
down_revision = 'c82976818c10'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('id', name='properties2_pkey')
    )
